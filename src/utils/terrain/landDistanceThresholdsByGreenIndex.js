...
const TABLES = Object.freeze({
    ...
    MiddleHighTemp: {
        A: [6, 12, 18, 25, 26, 20, 10, 16, 26, 30],
        B: [4, 10, 15, 22, 22, 17, 8, 13, 23, 27],
        C: [2, 7, 12, 18, 18, 14, 6, 10, 19, 23],
        D: [1, 4, 10, 15, 15, 11, 4, 8, 16, 20],
        E: [0, 2, 8, 13, 12, 9, 2, 6, 13, 16], // 現地球平均
        F: [-1, 1, 6, 10, 9, 6, 0, 4, 10, 13],
        G: [-1, 0, 4, 7, 7, 4, -1, 2, 7, 10],
        H: [-2, -1, 2, 4, 4, 1, -2, 0, 4, 7],
    ...
    MiddleLowTemp: {
        A: [5, 8, 16, 20, 22, 22, 14, 18, 23, 25],
        B: [4, 5, 12, 17, 20, 19, 12, 15, 20, 22],
        C: [3, 3, 10, 15, 17, 16, 10, 13, 17, 19],
        D: [2, 2, 8, 12, 15, 13, 8, 11, 14, 16],
        E: [1, 1, 6, 10, 11, 11, 6, 9, 11, 13],
        F: [0, 0, 4, 8, 10, 9, 4, 7, 9, 11],
        G: [-1, -1, 2, 6, 8, 8, 2, 5, 7, 8],
        H: [-2, -2, 0, 4, 4, 4, 0, 3, 5, 6],
        I: [-2, -2, -1, 1, 3, 3, -1, 1, 2, 3],
        J: [-2, -2, -2, -1, 0, 0, -2, -1, 0, 1]
    },

    // 【寒冷】氷河期の始まり。高緯度は雪と氷、森林は海岸線の避難所へ
    LowTemp: {
        A: [3, 5, 12, 18, 22, 24, 18, 20, 22, 22],
        B: [2, 3, 9, 15, 18, 20, 15, 17, 19, 19],
        C: [1, 2, 6, 11, 14, 17, 12, 14, 16, 16],
        D: [1, 1, 4, 8, 11, 14, 9, 11, 13, 13],
        E: [0, 0, 2, 6, 8, 11, 7, 9, 11, 11],
        F: [-1, 0, 1, 4, 6, 8, 5, 7, 9, 9],
    ...
    VeryLowTemp: {
        ...
        B: [0, 0, 4, 7, 12, 15, 14, 15, 17, 18],
        C: [0, 0, 2, 5, 9, 12, 11, 12, 14, 15],
        D: [-1, 0, 0, 3, 7, 10, 9, 10, 12, 13],
        E: [-2, -1, -1, 1, 4, 8, 7, 8, 10, 11],
    ...
    ExtremelyLowTemp: {
        A: [0, 0, 2, 6, 10, 14, 16, 18, 20, 20],
        B: [0, 0, 0, 4, 7, 11, 13, 15, 17, 17],
        C: [-1, -1, 0, 2, 5, 9, 11, 12, 14, 14],
        D: [-2, -1, 0, 0, 3, 7, 9, 10, 12, 12],
