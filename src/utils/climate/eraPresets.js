...
export function buildTurnAlphaParams(Turn_yr) {
    ...
    // 指定値以外は安全側で近い値へ丸め（実運用は指定セットのみ）
    const key = [10, 1000, 2000, 5000, 10000, 50000].includes(t) ? t
        : (t < 1000 ? 10 : (t < 2000 ? 1000 : (t < 5000 ? 2000 : (t < 10000 ? 5000 : (t < 50000 ? 10000 : 50000)))));
    ...
    return { GI_alpha, CO2_alpha, O2_alpha, Temp_alpha, alphaKey: key };
}
